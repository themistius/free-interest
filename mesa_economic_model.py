...
class EconomicModel(Model):
    ...
    def __init__(self, num_households=1000, num_firms=100, scenario=None, **params):
        ...
        self.cpi = 100
        self.interest_rate = params.get('initial_interest_rate', 0.03)
        self.natural_interest_rate = 0.02
        self.avg_wage = 3000
        self.gov_debt = 500_000
        
        # Shock multipliers
        self.productivity_shock = params.get('productivity_shock', 1.0)
        self.consumer_confidence_shock = params.get('confidence_shock', 1.0)
